...
class PositionalEncoding1D(nn.Module):
    def __init__(self, num_pos_feats=64, temperature=10000, normalize=False, scale=None):
        ...
        """
        super().__init__()
        print("___________________in adet/layers/pos_encoding/PositionalEncoding1D/__init__ _________")
    ...
    def forward(self, tensor):
        ...
        """
        print("___________________in adet/layers/pos_encoding/PositionalEncoding1D/forward _________")
        if tensor.ndim != 2:
...
class PositionalEncoding2D(nn.Module):
    ...
    def __init__(self, num_pos_feats=64, temperature=10000, normalize=False, scale=None):
        super().__init__()
        print("___________________in adet/layers/pos_encoding/PositionalEncoding2D/__init__ _________")
