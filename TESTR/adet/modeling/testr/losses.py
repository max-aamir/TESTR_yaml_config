...
def sigmoid_focal_loss(inputs, targets, num_inst, alpha: float = 0.25, gamma: float = 2):
    ...
    Returns:
        Loss tensor
    """
    print("___________________in adet/modelling/testr/losses/sigmoid_focal_loss _________")
    prob = inputs.sigmoid()
...
class SetCriterion(nn.Module):
    ...
    def __init__(self, num_classes, enc_matcher, dec_matcher, weight_dict, enc_losses, dec_losses, num_ctrl_points, focal_alpha=0.25, focal_gamma=2.0):
        ...
        """
        super().__init__()
        print("___________________in adet/modelling/testr/losses/class SetCriterion/__init__ _________")
    ...
    def loss_labels(self, outputs, targets, indices, num_inst, log=False):
        ...
        """
        print("___________________in adet/modelling/testr/losses/class SetCriterion/loss_labels _________")
    ...
    def loss_cardinality(self, outputs, targets, indices, num_inst):
        ...
        """
        print("___________________in adet/modelling/testr/losses/class SetCriterion/loss_cardinality _________")
    ...
    def loss_boxes(self, outputs, targets, indices, num_inst):
        ...
        """
        print("___________________in adet/modelling/testr/losses/class SetCriterion/loss_boxes _________")
    ...
    def loss_texts(self, outputs, targets, indices, num_inst):
        print("___________________in adet/modelling/testr/losses/class SetCriterion/loss_texts _________")
    ...
    def loss_ctrl_points(self, outputs, targets, indices, num_inst):
        ...
        """
        print("___________________in adet/modelling/testr/losses/class SetCriterion/loss_ctrl_points _________")
    ...
    def _get_src_permutation_idx(indices):
        print("___________________in adet/modelling/testr/losses/class SetCriterion/static _get_src_permutation_idx _________")
    ...
    def _get_tgt_permutation_idx(indices):
        print("___________________in adet/modelling/testr/losses/class SetCriterion/static _get_tgt_permutation_idx _________")
    ...
    def get_loss(self, loss, outputs, targets, indices, num_inst, **kwargs):
        print("___________________in adet/modelling/testr/losses/class SetCriterion/get_loss _________")
        loss_map = {
    ...
    def forward(self, outputs, targets):
        ...
        """
        print("___________________in adet/modelling/testr/losses/class SetCriterion/forward _________")
