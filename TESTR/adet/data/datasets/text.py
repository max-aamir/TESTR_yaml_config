...
def register_text_instances(name, metadata, json_file, image_root):
    ...
    """
    print("___________________in adet/data/datasets/text.py/register_text_instances___________________")
...
def load_text_json(json_file, image_root, dataset_name=None, extra_annotation_keys=None):
    print("___________________in adet/data/datasets/text.py/load_text_json___________________")
    """
