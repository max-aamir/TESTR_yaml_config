...
class CtrlPointHungarianMatcher(nn.Module):
    ...
    def __init__(self,
        ...
        """
        super().__init__()
        print("___________________in adet/modelling/testr/matcher/class CtrlPointHungarianMatcher/__init__ _________")
    ...
    def forward(self, outputs, targets):
        ...
        """
        print("___________________in adet/modelling/testr/matcher/class CtrlPointHungarianMatcher/forward _________")
        with torch.no_grad():
...
class BoxHungarianMatcher(nn.Module):
    ...
    def __init__(self,
        ...
        """
        super().__init__()
        print("___________________in adet/modelling/testr/matcher/class BoxHungarianMatcher/__init__ _________")
        self.class_weight = class_weight
        self.coord_weight = coord_weight
    ...
    def forward(self, outputs, targets):
        ...
        Returns:
            ...
            For each batch element, it holds:
                len(index_i) = len(index_j) = min(num_queries, num_target_boxes)
        """
        print("___________________in adet/modelling/testr/matcher/class BoxHungarianMatcher/forward _________")
        with torch.no_grad():
            bs, num_queries = outputs["pred_logits"].shape[:2]
...
def build_matcher(cfg):
    print("___________________in adet/modelling/testr/matcher/build_matcher _________")
