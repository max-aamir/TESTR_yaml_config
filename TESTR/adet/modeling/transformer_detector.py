...
class Joiner(nn.Sequential):
    def __init__(self, backbone, position_embedding):
        ...
        print("___________________in adet/modelling/transformer_detector/class Joiner/ __init__ _________")

    def forward(self, tensor_list: NestedTensor):
        print("___________________in adet/modelling/transformer_detector/class Joiner/ forward _________")
...
class MaskedBackbone(nn.Module):
    ...
    def __init__(self, cfg):
        super().__init__()
        print("___________________in adet/modelling/transformer_detector/class MaskedBackbone/ __init_ _________")
    ...
    def forward(self, images):
        print("___________________in adet/modelling/transformer_detector/class MaskedBackbone/ forward _________")
    ...
    def mask_out_padding(self, feature_shapes, image_sizes, device):
        print("___________________in adet/modelling/transformer_detector/class MaskedBackbone/ mask_out_padding _________")
        masks = []
...
def detector_postprocess(results, output_height, output_width, mask_threshold=0.5):
    ...
    """
    print("___________________in adet/modelling/transformer_detector/ detector_postprocess _________")
...
class TransformerDetector(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        print("___________________in adet/modelling/transformer_detector/class TransformerDetector/ __init_ _________")
    ...
    def preprocess_image(self, batched_inputs):
        ...
        """
        print("___________________in adet/modelling/transformer_detector/class TransformerDetector/ preprocess_image _________")
    ...
    def forward(self, batched_inputs):
        ...
        """
        print("___________________in adet/modelling/transformer_detector/class TransformerDetector/ forward _________")
    ...
    def prepare_targets(self, targets):
        print("___________________in adet/modelling/transformer_detector/class TransformerDetector/ prepare_targets _________")
        new_targets = []
    ...
    def inference(self, ctrl_point_cls, ctrl_point_coord, text_pred, image_sizes):
        print("___________________in adet/modelling/transformer_detector/class TransformerDetector/ inference _________")
