...
print("___________________in adet/data/builtin___________________")
...
def register_all_coco(root="datasets"):
    print("___________________in adet/data/builtin/register_all_coco(root=datasets):___________________")
