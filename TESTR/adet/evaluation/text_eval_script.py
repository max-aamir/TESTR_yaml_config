...
def evaluation_imports():
    print("___________________in adet/evaluation/text_eval_script/evaluation_imports_______________")
    """
...
def default_evaluation_params():
    print("___________________in adet/evaluation/text_eval_script/default_evaluation_params_______________")
    """
...
def validate_data(gtFilePath, submFilePath, evaluationParams):
    print("___________________in adet/evaluation/text_eval_script/validate_data______________")
    """
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    print("___________________in adet/evaluation/text_eval_script/evaluate_methods_______________")
    """
    ...
    def polygon_from_points(points):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/polygon_from_points______________")
        """
    ...
    def rectangle_to_polygon(rect):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/rectangle_to_polygon_____________")
    ...
    def rectangle_to_points(rect):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/rectange_to_points_____________")
        points = [int(rect.xmin), int(rect.ymax), int(rect.xmax), int(rect.ymax), int(rect.xmax), int(rect.ymin), int(rect.xmin), int(rect.ymin)]
        return points
        
    def get_union(pD,pG):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/get_union_______________")
        areaA = pD.area();
        areaB = pG.area();
        return areaA + areaB - get_intersection(pD, pG);
        
    def get_intersection_over_union(pD,pG):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/get_intersection_over_union____________")
        try:
    ...
    def get_intersection(pD,pG):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/get_intersection______________")
        pInt = pD & pG
        if len(pInt) == 0:
            return 0
        return pInt.area()
    ...
    def compute_ap(confList, matchList,numGtCare):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/compute_ap______________")
        correct = 0
        AP = 0
        if len(confList)>0:
    ...
    def transcription_match(transGt,transDet,specialCharacters=str(r'!?.:,*"()·[]/\''),onlyRemoveFirstLastCharacterGT=True):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/transcription_match______________")
    ...
    def include_in_dictionary(transcription):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/include_in_dictionary____________")
        """
    ...
    def include_in_dictionary_transcription(transcription):
        print("___________________in adet/evaluation/text_eval_script/evaluation_imports/include_in_dictionary_transcription____________")
        """
...
def text_eval_main(det_file, gt_file, is_word_spotting):
    print("___________________in adet/evaluation/text_eval_script/text_eval_main_____________")
    global WORD_SPOTTING
