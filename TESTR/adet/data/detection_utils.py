...
def transform_instance_annotations(
    ...
    print("___________________in adet/data/detection_utils/transform_instance_annotations_________________")
...
def transform_ctrl_pnts_annotations(pnts, transforms):
    print("___________________in adet/data/detection_utils/transform_ctrl_pnts_annotations_________________")
    """
...
def annotations_to_instances(annos, image_size, mask_format="polygon"):
    print("___________________in adet/data/detection_utils/annotations_to_instances_________________")
...
def build_augmentation(cfg, is_train):
    print("___________________in adet/data/detection_utils/build_augmentation_________________")
    """
