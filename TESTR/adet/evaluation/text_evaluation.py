...
class TextEvaluator(DatasetEvaluator):
    #print("___________________in adet/evaluation/text_evaluation/TextEvaluator_______________")
    """
    Evaluate text proposals and recognition.
    """

    def __init__(self, dataset_name, cfg, distributed, output_dir=None):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/init_______________")
    ...
    def reset(self):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/reset_______________")
        self._predictions = []

    def process(self, inputs, outputs):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/process_______________")
    ...
    def to_eval_format(self, file_path, temp_dir="temp_det_results", cf_th=0.5):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/to_eval_format_____________")
        def fis_ascii(s):
            print("___________________in adet/evaluation/text_evaluation/TextEvaluator/to_eval_format_/fis_ascii____________")
            a = (ord(c) < 128 for c in s)
            return all(a)

        def de_ascii(s):
            print("___________________in adet/evaluation/text_evaluation/TextEvaluator/to_eval_format_/de_ascii____________")
    ...
    def sort_detection(self, temp_dir):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/sprt_detection___________")
    ...
    def evaluate_with_official_code(self, result_path, gt_path):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/evaluate_with_official_code_________")
        return text_eval_script.text_eval_main(det_file=result_path, gt_file=gt_path, is_word_spotting=self._word_spotting)

    def evaluate(self):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/evaluate____________")
    ...
    def instances_to_coco_json(self, instances, img_id):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/instance_to_coco_json_________")
    ...
    def pnt_to_polygon(self, ctrl_pnt):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/pnt_to_polygon__________")
        if self.use_polygon:
    ...
    def ctc_decode(self, rec):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/ctc_decode___________")
        # ctc decoding
        last_char = False
        s = ''
        for c in rec:
    ...
    def decode(self, rec):
        print("___________________in adet/evaluation/text_evaluation/TextEvaluator/decode____________")
        s = ''
        for c in rec:
            c = int(c)
            if c < self.voc_size - 1:
