...
print("___________________in adet/data/dataset_mapper__________________")

def segmToRLE(segm, img_size):
    print("___________________in adet/data/dataset_mapper/segmToRLE(segm, img_size):__________________")
    h, w = img_size
    if type(segm) == list:
...
def segmToMask(segm, img_size):
    print("___________________in adet/data/dataset_mapper/segmToMask(segm, img_size):__________________")
...
class DatasetMapperWithBasis(DatasetMapper):
    ...
    def __init__(self, cfg, is_train=True):
        ...
        print("___________________in adet/data/dataset_mapper/class_DatasetMapperWithBasis(DatasetMapper):__init________________")
    ...
    def __call__(self, dataset_dict):
        ...
        """
        print("___________________in adet/data/dataset_mapper/class_DatasetMapperWithBasis(DatasetMapper):_/call________________")
