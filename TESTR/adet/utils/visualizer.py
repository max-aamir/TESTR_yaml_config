...
class TextVisualizer(Visualizer):
    def __init__(self, image, metadata, instance_mode, cfg):
        ...
        print("___________________in adet/utils/visualizer/class TextVisualizer/ __init__ _________")
    ...
    def draw_instance_predictions(self, predictions):
        print("___________________in adet/utils/visualizer/class TextVisualizer/ draw_instance_predictions _________")
        if self.use_polygon:
    ...
    def _ctrl_pnt_to_poly(self, pnt):
        print("___________________in adet/utils/visualizer/class TextVisualizer/ _ctrl_pnt_to_poly _________")
        if self.use_polygon:
    ...
    def _decode_recognition(self, rec):
        print("___________________in adet/utils/visualizer/class TextVisualizer/ _decode_recognition _________")
        s = ''
        for c in rec:
            c = int(c)
    ...
    def _ctc_decode_recognition(self, rec):
        # ctc decoding
        print("___________________in adet/utils/visualizer/class TextVisualizer/ _ctc_decode_recognition _________")
        last_char = False
        s = ''
        for c in rec:
            c = int(c)
    ...
    def overlay_instances(self, ctrl_pnts, recs, scores, alpha=0.5):
        print("___________________in adet/utils/visualizer/class TextVisualizer/ overlay_instances _________")
        color = (0.1, 0.2, 0.5)
    ...
    def draw_text(
        ...
        *,
        ...
        """
        print("___________________in adet/utils/visualizer/class TextVisualizer/ draw_text _________")
        if not font_size:
            font_size = self._default_font_size
