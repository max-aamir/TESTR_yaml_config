...
class MLP(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, output_dim, num_layers):
        super().__init__()
        print("___________________in adet/modelling/testr/models/class MLP/__init__ _________")
    ...
    def forward(self, x):
        print("___________________in adet/modelling/testr/models/class MLP/forward _________")
...
class TESTR(nn.Module):
    ...
    def __init__(self, cfg, backbone):
        super().__init__()
        print("___________________in adet/modelling/testr/models/class TESTR/__init__ _________")
    ...
    def forward(self, samples: NestedTensor):
        ...
        """
        print("___________________in adet/modelling/testr/models/class TESTR/forward _________")
    ...
    def _set_aux_loss(self, outputs_class, outputs_coord, outputs_text):
        ...
        print("___________________in adet/modelling/testr/models/class TESTR/_set_aux_loss _________")
