...
def print_help():
    print("___________________in adet/evaluation/rrc_evaluation_funcs/print_help________________")
    sys.stdout.write('Usage: python %s.py -g=<gtFile> -s=<submFile> [-o=<outputFolder> -p=<jsonParams>]' %sys.argv[0])
    sys.exit(2)
    

def load_zip_file_keys(file,fileNameRegExp=''):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/load_zip_file_keys_____________")
    """
...
def load_zip_file(file,fileNameRegExp='',allEntries=False):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/load_zip_file________________")
    """
...
def decode_utf8(raw):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/decode_utf8_______________")
    """
...
def validate_lines_in_file_gt(fileName,file_contents,CRLF=True,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/validate_lines_in_files_gt____________")
    """
...
def validate_lines_in_file(fileName,file_contents,CRLF=True,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/validate_lines_in_file_____________")
    """
    This function validates that all lines of the file calling the Line validation function for each line
    """
    utf8File = decode_utf8(file_contents)
...
def validate_tl_line_gt(line,LTRB=True,withTranscription=True,withConfidence=True,imWidth=0,imHeight=0):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/validate_tl_line_gt_____________")
    """
...
def validate_tl_line(line,LTRB=True,withTranscription=True,withConfidence=True,imWidth=0,imHeight=0):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/validate_tl_line______________")
    """
    Validate the format of the line. If the line is not valid an exception will be raised.
    If maxWidth and maxHeight are specified, all points must be inside the imgage bounds.
    Posible values are:
...
def get_tl_line_values_gt(line,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/get_tl_line_values_gt____________")
    """
    Validate the format of the line. If the line is not valid an exception will be raised.
    If maxWidth and maxHeight are specified, all points must be inside the imgage bounds.
    Posible values are:
...
def get_tl_line_values(line,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/get_tl_line_values_____________")
    """
    Validate the format of the line. If the line is not valid an exception will be raised.
    If maxWidth and maxHeight are specified, all points must be inside the imgage bounds.
    Posible values are:
...
def validate_point_inside_bounds(x,y,imWidth,imHeight):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/validate_point_inside_bounds_____________")
    if(x<0 or x>imWidth):
...
def validate_clockwise_points(points):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/validate_clockwise_points______________")
    """
...
def get_tl_line_values_from_file_contents(content,CRLF=True,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0,sort_by_confidences=True):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/get_tl_lines_values_from_file_contents__________")
    """
...
def get_tl_line_values_from_file_contents_det(content,CRLF=True,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0,sort_by_confidences=True):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/get_tl_line_values_from_file_contents_det_________")
    """
    Returns all points, confindences and transcriptions of a file in lists. Valid line formats:
    xmin,ymin,xmax,ymax,[confidence],[transcription]
    x1,y1,x2,y2,x3,y3,x4,y4,[confidence],[transcription]
...
def main_evaluation(p,det_file, gt_file, default_evaluation_params_fn,validate_data_fn,evaluate_method_fn,show_result=True,per_sample=True):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/main_evaluation_______________")
    """
...
def main_validation(default_evaluation_params_fn,validate_data_fn):
    print("___________________in adet/evaluation/rrc_evaluation_funcs/main_validation_______________")
    """
