...
class SetCriterion(nn.Module):
    ...
    def loss_ctrl_points(self, outputs, targets, indices, num_inst):
        ...
        loss_ctrl_points_1 = F.l1_loss(src_ctrl_points, target_ctrl_points, reduction='none')

        loss_ctrl_points = torch.sub(torch.mul(loss_ctrl_points_1 + 1,torch.log(loss_ctrl_points_1 + 1)),loss_ctrl_points_1).sum()
