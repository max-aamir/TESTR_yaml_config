...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 ...
                 num_proposals=300):
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformer/init___________")
    ...
    def _reset_parameters(self):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformer/reset_parameters__________")
    ...
    def get_proposal_pos_embed(self, proposals):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformer/get_proposal_pos_embed________")
        num_pos_feats = 64
        temperature = 10000
        scale = 2 * math.pi
    ...
    def gen_encoder_output_proposals(self, memory, memory_padding_mask, spatial_shapes):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformer/gen_ecoder_output_proposals________")
    ...
    def get_valid_ratio(self, mask):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformer/get_valid_ratio_________")
        _, H, W = mask.shape
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed, text_embed, text_pos_embed, text_mask=None):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformer/forward___________")
...
class DeformableTransformerEncoderLayer(nn.Module):
    def __init__(self,
        ...
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoderLayer/init___________")
        # self attention
    ...
    def with_pos_embed(tensor, pos):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoderLayer/static with_pos_embed_________")
        return tensor if pos is None else tensor + pos

    def forward_ffn(self, src):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoderLayer/forward_ffn__________")
    ...
    def forward(self, src, pos, reference_points, spatial_shapes, level_start_index, padding_mask=None):
        # self attention
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoderLayer/forward___________")
...
class DeformableTransformerEncoder(nn.Module):
    def __init__(self, encoder_layer, num_layers):
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoder/init___________")
        self.layers = _get_clones(encoder_layer, num_layers)
        self.num_layers = num_layers

    @staticmethod
    def get_reference_points(spatial_shapes, valid_ratios, device):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoder/static get_reference_points_________")
    ...
    def forward(self, src, spatial_shapes, level_start_index, valid_ratios, pos=None, padding_mask=None):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerEncoder/forward___________")
        output = src
...
class DeformableTransformerDecoderLayer(nn.Module):
    def __init__(self, d_model=256, d_ffn=1024,
                 ...
                 n_levels=4, n_heads=8, n_points=4):
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerDecoderLayer/init___________")
        # cross attention
    ...
    @staticmethod
    def with_pos_embed(tensor, pos):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerDecoderLayer/static with_pos_embed_________")
        return tensor if pos is None else tensor + pos

    def forward_ffn(self, tgt):
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerDecoderLayer/forward_ffn________")
    ...
    def forward(self, tgt, query_pos, reference_points, src, src_spatial_shapes, level_start_index, src_padding_mask=None):
        # self attention
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerDecoderLayer/forward_________")
...
class DeformableTransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers, return_intermediate=False):
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerDecoder/init_________")
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
        ...
        print("___________________in adet/layers/deformable_transformers/class DeformableTransformerDecoder/forward_________")
        output = tgt
...
class DeformableCompositeTransformerDecoderLayer(nn.Module):
    def __init__(self, d_model=256, d_ffn=1024,
                 ...
                 n_levels=4, n_heads=8, n_points=4):
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoderLayer/init_________")
    ...
    @staticmethod
    def with_pos_embed(tensor, pos):
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoderLayer/with_pos_embed_______")
        return tensor if pos is None else tensor + pos

    def forward_ffn(self, tgt):
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoderLayer/forward_ffn________")
        tgt2 = self.linear2(self.dropout3(self.activation(self.linear1(tgt))))
        tgt = tgt + self.dropout4(tgt2)
        tgt = self.norm3(tgt)
        return tgt
    ...
    def forward_ffn_text(self, tgt):
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoderLayer/forward_ffn_text_______")
    ...
    def forward(self, tgt, query_pos, tgt_text, query_pos_text, reference_points, src, src_spatial_shapes, level_start_index, src_padding_mask=None, text_padding_mask=None):
        ...
        # self attention (intra)
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoderLayer/forward_________")
        q = k = self.with_pos_embed(tgt, query_pos)
...
class DeformableCompositeTransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers, return_intermediate=False):
        super().__init__()
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoder/init_________")
        self.layers = _get_clones(decoder_layer, num_layers)
        self.num_layers = num_layers
        self.return_intermediate = return_intermediate
        # hack implementation for iterative bounding box refinement and two-stage Deformable DETR
    ...
    def forward(self, tgt, tgt_text, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
        ...
        print("___________________in adet/layers/deformable_transformers/class DeformableCompositeTransformerDecoder/forward_________")
...
def _get_clones(module, N):
    print("___________________in adet/layers/deformable_transformers/get_clones_________")
    return nn.ModuleList([copy.deepcopy(module) for i in range(N)])


def _get_activation_fn(activation):
    print("___________________in adet/layers/deformable_transformers/get_activation_________")
